...
> **Para las fotos de producto hay un atajo:** `npm run fotos` las baja todas
> desde el sitio actual de ECO, ya nombradas como corresponde. Ver el
> [README](../../../../README.md#cómo-cargar-las-fotos).
